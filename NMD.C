...
{
  switch(t) {
  case NMD_NONE:       os<<"none"<<endl; break;
  case NMD_NMD:        os<<"NMD"<<endl; break;
  case NMD_TRUNCATION: os<<"truncation"<<endl; break;
  case NMD_NO_STOP:    os<<"nonstop"<<endl; break;
  case NMD_NO_START:   os<<"noncoding"<<endl; break;
  }
}
